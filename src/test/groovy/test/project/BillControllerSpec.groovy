...
class BillControllerSpec extends Specification implements ControllerUnitTest<BillController>, DomainUnitTest<Bill> {
    ...
    def populateValidParams(params) {
        ...
        Business business = new Business(name: "André Cunha", email:"aandrecunhas",
                monthlyRevenue: 10000, enterpriseName:"André Móveis")
        business.save()

        params["baseRatePercentage"] = 1.65
        params["originalValue"] = 1500
        params["daysToPay"] = 28
        params["business.id"] = business.id
    }
